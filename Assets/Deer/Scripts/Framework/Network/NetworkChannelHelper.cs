...
namespace Deer.Scripts.Framework.Network
{
    public class NetworkChannelHelper : INetworkChannelHelper,IReference
    {
        ...
        {
            Heart csHeartBeat = new Heart();
            csHeartBeat.Time = TimeUtils.DateTime2TimeStamp(DateTime.Now);
            CSProtoPacket csProtoPacket = ReferencePool.Acquire<CSProtoPacket>();
            csProtoPacket.protoId = (short)Protocol.HeartBeat;
        ...
        public bool Serialize<T>(T packet, Stream destination) where T : Packet
        {
            ...
            packetHeader.Id = packetImpl.protoId;
