...
namespace Deer
{
    public class ProcedurePreload : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            GameEntry.Sound.AddSoundGroup(Constant.SoundGroup.Music,1);
            GameEntry.Sound.AddSoundGroup(Constant.SoundGroup.UISound,10);
            GameEntry.Sound.AddSoundGroup(Constant.SoundGroup.Sound,100);
            PreloadConfig();
