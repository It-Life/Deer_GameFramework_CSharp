...
{
    //脚本模板路径
    private const string TemplateUIScriptPath = "Assets/Editor/Lazy/GenScriptTool/Template/MyTemplateUIScript.cs.txt";
    ...
    //菜单项
    [MenuItem("Assets/Create/CSharpScript/C# UIFrameScript", false, 1)]
...
+ " * ChangeCreator：#Author# \n"
+ " * ChangeTime：#CreatTime#\n"
